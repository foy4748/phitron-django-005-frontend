...
export default function Footer() {
  ...
  return (
    <>
      <GridSystem className="max-w-[1400px] mx-auto bg-green-900 px-20 py-10 text-white gap-x-10">
        <Col className="flex justify-center">
          <section>
            <figure className="flex justify-start mb-3">
              <Link href="/" className="flex gap-x-3 items-center text-primary">
      ...
      <section className="md:col-span-12 lg:col-span-12 bg-green-950 text-white text-center py-3">
        <p>
          Copyright &copy; {new Date().getFullYear()} Super Grocery. All rights
          preserved
        </p>
      </section>
    </>
